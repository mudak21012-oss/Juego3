...
const environment = {
  ...
  indices: {
    ...
    block: 0x17,
    doors: {
      horizontal: 0x81, // Puerta para norte/sur (arriba/abajo) - v1.7.1 restaurada
      vertical: 0x90,   // Puerta para este/oeste (costados) - rotada 180° 
      destroyed: null   // Sin sprite cuando está destruida
    },
    walls: {
      alone: 0x14,
      intersections: {
